<script>
    ...
    function process(data) {
        ...
        const isNoneOfTheAbove = (d) =>
            !Object.values(groupFilters).some((filter) => filter(d));
        ...
        const expenditureFinancedByIncome = Math.min(
            incomeAvailable,
            totalExpenditure,
        );
        const expenditureFinancedBySavings =
            totalExpenditure - expenditureFinancedByIncome;
